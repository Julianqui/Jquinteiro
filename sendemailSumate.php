...
function sendemail($mail_setFromEmail,$mail_setFromName,$txt_message,$mail_subject){
	...
	$template="email_sumate.html";//Ruta de la plantilla HTML para enviar nuestro men=
	...
	$message = str_replace('{{sumatenombre}}', $mail_setFromName, $message);
	$message = str_replace('{{sumatepuesto}}', $txt_message, $message);
	$message = str_replace('{{mailsumate}}', $mail_setFromEmail, $message);
...
$mail_subject = "Sumate al equipo";
//$mail_subject=$_POST['sumatenombre'];
$mail_setFromName=$_POST['sumatenombre'];
$txt_message=$_POST['sumatepuesto'];
//var_dump($_POST['mailsumate']);
$mail_setFromEmail=$_POST['mailsumate'];
sendemail($mail_setFromEmail,$mail_setFromName,$txt_message,$mail_subject);
	?>

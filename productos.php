<style>
    .mail,.organismo, .nombre, .mensajemodal{
        display: none;
    }
...
<section id="soluciones" class="p-b-0" style="background-color: #F2F3F4; ">
    <div class="container">
        <br>
        <h2><center>Creamos soluciones digitales</center></h2>
    </div>
</section>

<section style="background-color: #F2F3F4; padding-bottom: 0px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
-->
                        <a class="panel panel-default panel-icon" data-toggle="modal" data-target="#modalLarge" href="">
                            <div class="panel-heading" style="background-image:url(img/1-jimenez.png);min-height:188px;"></div>
                            <header class="panel-body">
                                <h4 style="font-weight: 500;">Bot administrativo</h4>
                    ...
                    <div class="col-md-4">
                        <a type="button" class="panel panel-default panel-icon" data-toggle="modal" data-target="#modalLargeFis" href="">
                            <div class="panel-heading" style="background-image:url(img/2-fiscalizar.png);min-height:188px;"></div>
                            <header class="panel-body">
                                <h4 style="font-weight: 500;">Fiscalizaciones digitales</h4>
                    ...
                    <div class="col-md-4">
                        <a type="button" class="panel panel-default panel-icon" data-toggle="modal" data-target="#modalLargeMo" href="">
                            <div class="panel-heading" style="background-image:url(img/3-moto.png);min-height:188px;"></div>
                            <header class="panel-body">
                                <h4 style="font-weight: 500;">Trámites online</h4>
                    ...
                    <div class="col-md-4">
                        <a type="button" class="panel panel-default panel-icon" data-toggle="modal" data-target="#modalLargeGe" href="">
                            <div class="panel-heading" style="background-image:url(img/4-tablero-de-gestion.png);min-height:188px;"></div>
                            <header class="panel-body">
                                <h4 style="font-weight: 500;">Medición y transparencia</h4>
                    ...
                    <div class="col-md-4">
                        <a type="button" class="panel panel-default panel-icon" data-toggle="modal" data-target="#modalLargeMuni" href="">
                            <div class="panel-heading" style="background-image:url(img/5-municipios.png);min-height:188px;"></div>
                            <header class="panel-body">
                                <h4 style="font-weight: 500;">Gestión integral</h4>
                    ...
                    <div class="col-md-4">
                        <a type="button" class="panel panel-default panel-icon" data-toggle="modal" data-target="#modalLargeConciliar" href="">
                            <div class="panel-heading" style="background-image:url(img/7-conciliar.jpg);min-height:188px;"></div>
                            <header class="panel-body">
                                <h4 style="font-weight: 500;">Reclamos online</h4>
                                <p style="font-size: 16px;">Plataforma de reclamos de consumidores online, se disponibiliza un espacio que promueva la comunicación de las partes y la resolución de sus diferencias.</p>
                            </header>
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a type="button" class="panel panel-default panel-icon" data-toggle="modal" data-target="#modalLargeLibro" href="">
                            <div class="panel-heading" style="background-image:url(img/6-libro.jpg);min-height:188px;"></div>
                            <header class="panel-body">
                                <h4 style="font-weight: 500;">Registro digital</h4>
                                <p style="font-size: 16px;">La valorización de un servicio puede hacerse desde una plataforma 100% digital, donde el Estado tiene un rol de auditor.</p>
                            </header>
                        </a>
                    </div>
